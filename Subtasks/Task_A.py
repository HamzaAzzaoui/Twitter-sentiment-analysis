...
#Load Dev Test
gold_test_data = pd.read_csv("Data/twitter-2016devtest-A.txt", sep="\t", header=None, names=['tweet_id', 'class', 'tweet_text'])

#Final Test Data
final_test_data = pd.read_csv("Data/twitter-2016test-A.txt", sep="\t", header=None, names=['tweet_id', 'class', 'tweet_text', 'nan'])
